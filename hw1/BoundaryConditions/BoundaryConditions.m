function [A, b, u_g] = BoundaryConditions(A,b,femregion,Data,t)
...
if strcmp(Data.boundary,'DD')   
    ...
    u_g(boundary_points(1)) = Data.gD1(t); 
    u_g(boundary_points(2)) = Data.gD2(t);
...
elseif strcmp(Data.boundary(2),'D')
    ...
    u_g(boundary_points(1)) = Data.gD2(t); 
